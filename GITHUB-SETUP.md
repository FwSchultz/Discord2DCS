...
7. Den Inhalt des Pakets `Discord2DCS-GitHub-Repository-v0.10.0-beta.zip` **in den Repository-Ordner** kopieren.
...
10. Commit-Vorschlag: `Prepare Discord2DCS 0.10.0-beta`
11. Push origin.
